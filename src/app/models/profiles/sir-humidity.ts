...
export class SIRHumidity extends ModelProfile {
    public profileName = "SIR: Varied Humidity";
    public states = [CellStates.Susceptible, CellStates.Infected, CellStates.Removed];

    private infectionRate = (rowIndex: number, columnIndex: number) => {
        return ((rowIndex > 36) && (columnIndex > 36)) ? 0.2: 0.5;
    };
